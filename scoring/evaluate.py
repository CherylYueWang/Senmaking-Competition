...
def main():
    ...
    if os.path.isdir(submit_dir) and os.path.isdir(truth_dir):
        ...
        for submission_file in submission_files:
            if submission_file in [taskA_file, taskB_file, taskC_file]:
                valid_submission_files.append(submission_file)
        if taskA_file in valid_submission_files:
        ...
        if taskB_file in valid_submission_files:
            gold_labels_file = os.path.join(
        ...
        if taskC_file in valid_submission_files:
